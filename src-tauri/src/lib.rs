...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::tasks::start_task_with_prerequisites,
            commands::tasks::start_task_despite_stopped_run,
            ...
            commands::blockers::get_blocker,
            commands::blockers::task_blockers,
            commands::blockers::answer_blocker,
            commands::blockers::cancel_blocker,
            commands::discussion::get_discussion,
            commands::discussion::post_discussion_message,
            commands::discussion::resume_with_discussion,
