export default {
  ...
  'projectModal.autoMerge': 'Otomatik Birleştirme',
  'projectModal.autoMergeDesc': 'Görev tamamlandığında dalını temel dala birleştir',
  'projectModal.autoMergePrConflict': 'Otomatik PR açıkken kullanılamaz — dalı pull request yükler',
  ...
  'board.artifacts': 'Çıktılar',
  'board.terminal': 'Terminal',

  // ─── Çıktılar ───
  'artifacts.title': 'Çıktılar',
  'artifacts.desktopOnly': 'Çıktılar yalnızca masaüstü uygulamasında kullanılabilir.',
  'artifacts.search': 'Çıktılarda ara...',
  'artifacts.fileCount': '{count} dosya',
  'artifacts.refresh': 'Yenile',
  'artifacts.empty': 'Çıktı bulunamadı',
  'artifacts.emptyDesc': 'Bu projede yazılan markdown dosyaları burada görünür.',
  'artifacts.loadFailed': 'Çıktılar yüklenemedi',
  'artifacts.selectPrompt': 'Önizlemek için bir dosya seçin.',
  'artifacts.preview': 'Önizleme',
  'artifacts.edit': 'Düzenle',
  'artifacts.save': 'Kaydet',
  'artifacts.saved': 'Kaydedildi',
  'artifacts.unsaved': 'Kaydedilmemiş değişiklikler',
  'artifacts.reveal': 'Konumu Aç',
  'artifacts.copyPath': 'Yolu kopyala',
  'artifacts.copied': 'Kopyalandı',
  'artifacts.createdBy': 'Oluşturan',
  'artifacts.kind.all': 'Tümü',
  'artifacts.kind.plan': 'Planlar',
  'artifacts.kind.rfc': 'RFC’ler',
  'artifacts.kind.spec': 'Şartnameler',
  'artifacts.kind.readme': 'BENİOKU',
  'artifacts.kind.doc': 'Dokümanlar',
  'artifacts.kind.other': 'Diğer',
